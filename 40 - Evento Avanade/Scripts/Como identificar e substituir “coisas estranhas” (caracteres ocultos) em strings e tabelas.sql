...
SELECT * FROM #Teste WHERE Nome = 'WOLJRTLV'
SELECT * FROM #Teste WHERE Nome LIKE 'WOLJRTLV%'
...
SELECT * FROM #Teste WHERE Nome = 'JXCCOEVFÇ'
...
FROM
	#Teste
WHERE
	dbo.fncRemove_Caracteres_Ocultos(Nome) = 'JXCCOEVFÇ'
