...
SELECT * FROM dbo.Tabela_Temporal
FOR SYSTEM_TIME AS OF '2020-09-26 07:15:58'
ORDER BY Dt_Inicio, Id


-- Retorna todas as alterações num intervalo de tempo (Dt_Inicial < data final informada e campo Dt_Final > data inicial informada)
SELECT * FROM dbo.Tabela_Temporal
FOR SYSTEM_TIME FROM '2020-09-26 07:15:00' TO '2020-09-26 07:15:58'
ORDER BY Dt_Inicio, Id


-- Retorna todas as alterações num intervalo de datas (Dt_Inicial <= data final informada e campo Dt_Final > data inicial informada)
SELECT * FROM dbo.Tabela_Temporal
FOR SYSTEM_TIME BETWEEN '2020-09-26 07:15:00' AND '2020-09-26 07:15:58'
ORDER BY Dt_Inicio, Id


-- Retorna todas as alterações num intervalo de datas (Dt_Inicial >= data inicial informada e campo Dt_Final <= data final informada)
SELECT * FROM dbo.Tabela_Temporal
FOR SYSTEM_TIME CONTAINED IN('2020-09-26 07:15:58', '2020-09-26 07:16:01')
ORDER BY Dt_Inicio, Id
